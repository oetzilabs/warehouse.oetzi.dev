...
export class AreaService extends Effect.Service<AreaService>()("@warehouse/areas", {
  effect: Effect.gen(function* (_) {
    ...
    const findById = Effect.fn("@warehouse/areas/findById")(function* (id: string) {
    ...
    const update = Effect.fn("@warehouse/areas/update")(function* (
      input: InferInput<typeof WarehouseAreaUpdateSchema>,
    ) {
    ...
    const remove = Effect.fn("@warehouse/areas/remove")(function* (id: string) {
      const parsedId = safeParse(prefixed_cuid2, id);
      if (!parsedId.success) {
        return yield* Effect.fail(new AreaInvalidId({ id }));
      }
    ...
    const findByFacilityId = Effect.fn("@warehouse/areas/findByFacilityId")(function* (facilityId: string) {
