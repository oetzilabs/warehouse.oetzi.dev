...
export class SeedService extends Effect.Service<SeedService>()("@warehouse/seed", {
  effect: Effect.gen(function* (_) {
    ...
    const createStorage = Effect.fn("@warehouse/seed/createStorage")(function* (
    ...
    const seedStorage = (
      storage: InferInput<typeof StorageSchema>,
      areaId: string | null,
    ): Effect.Effect<Effect.Effect.Success<ReturnType<typeof createStorage>>, StorageNotCreated | SqlError> =>
    ...
    const seed = Effect.fn("@warehouse/seed/seed")(function* () {
