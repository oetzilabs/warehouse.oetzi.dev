...
export function Header() {
  ...
  return (
    <div class="flex flex-col w-full">
      <header class="bg-neutral-50/[0.01] dark:bg-neutral-950/[0.01] backdrop-blur-md flex flex-col px-0 items-center justify-between border-b border-neutral-200 dark:border-neutral-800">
