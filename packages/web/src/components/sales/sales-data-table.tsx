...
export function SalesDataTable(props: {
  data: Accessor<SaleInfo[]>;
  onSelectedSale?: (sale: SaleInfo | null) => void;
}) {
    ...
    <div class="w-full flex flex-col gap-4">
      <div class="flex items-center gap-4 justify-between w-full">
        <TextField
          ...
          class="w-full"
        >
          <TextFieldInput placeholder="Filter orders..." class="max-w-full ext-sm leading-0 rounded-lg px-4" />
        </TextField>
            ...
            {table.getRowModel().rows?.length ? (
              table.getRowModel().rows.map((row) => (
                <TableRow
                  ...
                  onClick={() => props.onSelectedSale?.(row.original)}
