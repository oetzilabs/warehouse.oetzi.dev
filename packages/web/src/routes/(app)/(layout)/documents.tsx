            ...
            <div class="w-full p-4 flex flex-col gap-4">
              <div class="flex items-center gap-4 justify-between w-full">
                ...
                <div class="flex items-center gap-4">
                  ...
                  <Button size="sm" class="h-8 pl-3">
                    <Upload class="size-4" />
                    Upload
                  </Button>
                </div>
              </div>
              <DocumentList documents={ds} searchBy={["path", "type"]} setSelectedDocument={setSelectedDocument} />
            </div>
      ...
      <div class="flex flex-row items-center gap-4 justify-between w-full">
        <div class="flex flex-row items-center gap-4 w-full">
          <TextField class="w-full" value={search()} onChange={(value) => setSearch(value)}>
            <TextFieldInput class="w-full rounded-lg px-4" placeholder="Search documents..." />
          </TextField>
        </div>
