    ...
    <div class="flex flex-col-reverse md:flex-row w-full gap-0 h-full">
      <div class="flex flex-col gap-4 w-full p-4 border-r-0 md:border-r h-full overflow-auto">
        <div class="grid grid-cols-2 md:grid-cols-4 w-full border border-neutral-200 dark:border-neutral-800 rounded-lg text-neutral-700 dark:text-neutral-300 items-center">
          ...
          <A class="flex flex-col gap-4 p-4 w-full hover:bg-muted-foreground/5 h-full min-h-36 md:min-h-28" href="#">
            <div class="flex items-center gap-4 justify-between w-full">
        ...
        <div class="flex flex-col gap-4 w-full grow">
          <Show when={data()}>
            {(d) => (
              <>
                <div class="flex flex-col w-full h-content border border-neutral-200 dark:border-neutral-800 rounded-lg">
                        ...
                        {(item) => (
                          <div class="flex flex-row items-center gap-3 p-4 border-b last:border-b-0 border-neutral-200 dark:border-neutral-800 hover:bg-muted-foreground/[0.025] dark:hover:bg-muted/15 transition-colors h-full">
                            ...
                            <div class="flex flex-col grow">
                              <span class="font-medium text-neutral-900 dark:text-neutral-100">{item.order.title}</span>
                ...
                <div class="flex flex-col w-full h-content border border-neutral-200 dark:border-neutral-800 rounded-lg">
                  <div class="flex flex-row items-center justify-between p-2 pl-4 bg-muted-foreground/5 dark:bg-muted/30">
                    ...
                    <div class="flex flex-row gap-2">
                      <Button size="sm" as={A} href="/purchases/new" disabled variant="outline" class="bg-background">
                        <span class="sr-only md:not-sr-only">Create</span>
                        <Plus class="size-4" />
                      </Button>
